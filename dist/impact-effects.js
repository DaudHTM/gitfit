...
const COLORS={parry:'#e3faff',riposte:'#afffe0',punch:'#ffd19b',knockout:'#ffe5ae',armor:'#d8e7ff',slash:'#8fffe5',block:'#88dfff',ring:'#ffdc79',target:'#c8ffa0',hurt:'#de785a',miss:'#c2c6c9'};
...
export function createImpactEffects(scene){
 ...
 function burst(point,kind='punch',power=1,direction=null){
  ...
  if(['slash','armor','parry','riposte'].includes(kind))ring(p,kind,power,true,direction?Math.atan2(direction.y,direction.x):-.5);
