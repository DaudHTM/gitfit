...
Path('dist/guide.html').write_text('<!doctype html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Armature — Build guide</title><link rel="stylesheet" href="style.css"></head><body><header><a class="brand" href="./">← ARMATURE / MOTION LAB</a></header><main class="docs"><p><a href="ArmTracker.ino" download>Download ESP32 sketch</a> · <a href="README.md" download>Download setup guide</a></p>'+''.join(parts)+'</main></body></html>')
